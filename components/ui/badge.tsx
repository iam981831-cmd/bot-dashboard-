  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        error:
          "border-transparent bg-red-500/20 text-red-600 dark:bg-red-500/20 dark:text-red-400",
        maintenance:
          "border-transparent bg-blue-500/20 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400",
      },
    },
    defaultVariants: {
      variant: "default",
